...
{
	protected TimeSince TimeSinceFootShuffle { get; set; } = 60;
	protected float DuckAmount { get; set; } = 0f;
	...
	public override void Simulate()
	{
		...
		if ( HasTag( "ducked" ) ) DuckAmount = DuckAmount.LerpTo( 1.0f, Time.Delta * 10.0f );
		else DuckAmount = DuckAmount.LerpTo( 0.0f, Time.Delta * 5.0f );

		SetAnimParameter( "duck", DuckAmount );
